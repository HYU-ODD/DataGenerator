...
class CustomDescriptor:
    def __init__(self, bp_id=None,type=None, bbox=None, dimensions=None, location=None, rotation_y=None, extent=None):
        self.bp_id = None
        self.type = type
        self.truncated = 0
        self.occluded = 0
    ...
    def __str__(self):
        ...
        if (self.bp_id is None): # kitti format
            return "{} {} {} {} {} {} {} {}".format(self.type, self.truncated, self.occluded,
                                                         self.alpha, bbox_format, self.dimensions, self.location,
                                                         self.rotation_y)
        else:
            return "{} {} {} {} {} {} {} {} {}".format(self.bp_id, self.type, self.truncated, self.occluded,
                                                         self.alpha, bbox_format, self.dimensions, self.location,
                                                         self.rotation_y)
